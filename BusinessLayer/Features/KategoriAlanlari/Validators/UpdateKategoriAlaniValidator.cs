...
{
    public sealed class UpdateKategoriAlaniValidator : AbstractValidator<UpdateKategoriAlaniRequest>
    {
        public UpdateKategoriAlaniValidator()
        {
            RuleFor(x => x.Id)
                .GreaterThan(0).WithMessage("Geçerli bir alan ID'si gereklidir.");
