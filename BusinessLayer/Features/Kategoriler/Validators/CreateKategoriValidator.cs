...
namespace BusinessLayer.Features.Kategoriler.Validators
{
    public sealed class CreateKategoriValidator : AbstractValidator<CreateKategoriRequest>
    {
        public CreateKategoriValidator()
        {
            ...
            RuleFor(x => x.SeoSlug)
                .NotEmpty().WithMessage("SeoSlug boş olamaz.")
                .MinimumLength(2).WithMessage("SeoSlug en az 2 karakter olmalı.")
                .MaximumLength(150).WithMessage("SeoSlug en fazla 150 karakter olmalı.");
